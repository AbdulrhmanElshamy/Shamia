...
namespace Shamia.API.Controllers
{
    public class UserController : ControllerBase
    {
        ...
        public UserController(UserManager<User> userManager, ShamiaDbContext shamiaDbContext)
        {
            _userManager = userManager;
            _context = shamiaDbContext;
        }
        ...
        public async Task<IActionResult> GetUserDetails(string userId)
        {
            ...
            return Ok(new
            {
                ...
                Orders = orders.Select(o => new
                {
                    ...
                    Payment_Method = o.Payment_Method ?? "Can't Find Payment Method",
                    Status = o.Status_En,
