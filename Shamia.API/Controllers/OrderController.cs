...
namespace Shamia.API.Controllers
{
    public class OrderController : ControllerBase
    {
        ...
        public OrderController(IOrderService orderService, IHubContext<NotificationHub>  notificationHub)
        {
            ...
            (bool isSuccess, ErrorResponse? errorResponse, T? response) result)
        {
            ...
            _notificationHub.Clients.All.SendAsync("ReceiveMessage", NotificationTemplets.SetMessage(userName));
