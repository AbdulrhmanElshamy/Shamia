...
{
    /// <summary>
    /// Provides administrative dashboard functionality and data exports
    /// </summary>
    public class DashboardController : ControllerBase
    {
        ...
        /// <summary>
        /// Exports product catalog to Excel format
        /// </summary>
        /// <returns>Excel file with product data</returns>
        ...
        /// <summary>
        /// Exports order history to Excel format
        /// </summary>
        /// <returns>Excel file with order data</returns>
